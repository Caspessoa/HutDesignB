...
export function Header(){
    return (
        <header className="border-b border-gray-200 w-full fixed top-0 z-50">
            <div className="max-w-7xl mx-auto px-8 py-2 flex flex-wrap justify-between items-center gap-4">
                ...
                <nav className="flex flex-wrap items-center gap-4 md:gap-8">
                    ...
                    <a href="#contato" className="bg-purple-800 text-white font-bold px-6 py-2 rounded-full shadow-lg shadow-purple-800/40 hover:bg-purple-900 transition-colors">
                    Fale Conosco
                    </a>
                </nav>  
